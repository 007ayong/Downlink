  ...
  function createSettingsController({
    ...
    function bindSettingsEvents() {
      ...
      [
        ...
        const updateLauncherNameIfNeeded = () => {
          if (id !== 'cfgLauncherName') return;
          const nextCfg = { ...getCurrentConfig(), externalLauncherName: el.value.trim() || 'AB Download' };
          setCurrentConfig(nextCfg);
          updateDynamicLabels(nextCfg);
          updateHeaderStatusDisplay({ cfg: nextCfg, state: 'checking' });
          syncGlobals();
