(function initPopupSettings(global) {
    ...
    function collectSettingsFromForm() {
      ...
      return {
        ...
        aria2Silent,
        aria2CustomSaveEnabled: !aria2Silent && document.getElementById('cfgAria2CustomSaveEnabled').checked,
    ...
    function loadSettings(cfg) {
      ...
      normalizedCfg.aria2CustomSaveEnabled = !!normalizedCfg.aria2CustomSaveEnabled && !normalizedCfg.aria2Silent;
    ...
    function bindSettingsEvents() {
      ...
      ['cfgAutoCapture', 'cfgMediaSniffing', 'cfgAria2Silent', 'cfgAria2CustomSaveEnabled', 'cfgUseMotrixNext', 'cfgMotrixBridgeAutoClose', 'cfgAbDownloadSilent', 'cfgSkipSmallDownloads'].forEach((id) => {
