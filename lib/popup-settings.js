(function initPopupSettings(global) {
    ...
    function loadSettings(cfg) {
      ...
      document.getElementById('cfgSaveDir').value = normalizedCfg.saveDir || '';
      ...
      document.getElementById('cfgCaptureBypassModifier').value = normalizeShortcutInput(normalizedCfg.captureBypassModifier || 'alt');
