(function initPopupSettings(global) {
    ...
    function bindSettingsEvents() {
      ...
      ['cfgAutoCapture', 'cfgAria2Silent', 'cfgAria2CustomSaveEnabled', 'cfgUseMotrixNext', 'cfgAbDownloadSilent', ...(hideSmallDownloadSettings ? [] : ['cfgSkipSmallDownloads'])].forEach((id) => {
