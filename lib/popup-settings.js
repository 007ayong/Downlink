(function initPopupSettings(global) {
    ...
    function bindSettingsEvents() {
      ...
      ['cfgAutoCapture', 'cfgAria2Silent', 'cfgAria2CustomSaveEnabled', 'cfgUseMotrixNext', 'cfgMotrixBridgeAutoClose', 'cfgAbDownloadSilent', 'cfgSkipSmallDownloads'].forEach((id) => {
